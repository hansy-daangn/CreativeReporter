/* Minimal synchronous SHA-256 (hex) for offline password check. Public-domain style impl.
   Matches Postgres encode(digest(pw,'sha256'),'hex') on the UTF-8 bytes of pw. */
(function () {
